...
public class Drivetrain extends SubsystemBase {
  ...
  public void periodic() {
    ...
    if (estRobotPose.isPresent()) {
      ...
      Pose2d badPose = estRobotPoseData.estimatedPose.toPose2d();


      if (badPose.getTranslation().getDistance(lastPose.getTranslation()) >= Vision.kPoseEpsilon) {
    ...
    if (headingLocked) {
      drive(0, 0, rotationController.calculate(getHeading().getDegrees(), headingTarget), false, false);
