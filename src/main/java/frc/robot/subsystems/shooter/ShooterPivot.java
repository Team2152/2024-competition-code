...
public class ShooterPivot extends SubsystemBase{
    ...
    public ShooterPivot(int pivotMotorCanId, double gearRatio) {
        ...
        slot0Configs.kS = 0.148;// * gearRatio; // Add 0.25 V output to overcome static friction
        ...
        motionMagicConfigs.MotionMagicAcceleration = 250 / gearRatio; // Target acceleration of 160 rps/s (0.5 seconds)
